...
public class Facade
{
    ...
    public Set<Function> getFunctions()
    {
        ...
        {
            functions = this.coa.getFacadeFunctions(this);
        }
    ...
    public Set<GlobalVariable> getGlobalVariables()
    {
        ...
        {
            globalVariables = this.coa.getFacadeGlobalVariables(this);
        }
    ...
    public Set<ComplexType> getComplexTypes()
    {
        ...
        {
            complexTypes = this.coa.getFacadeComplexTypes(this);
        }
